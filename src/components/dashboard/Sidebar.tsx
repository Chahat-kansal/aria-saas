...
const ALL_ITEMS: Record<string, NavItemDef> = {
  ...
  'finance':                    { href: '/dashboard/finance',                 label: 'Finance (P&L)',     icon: DollarIcon,         section: 'Intelligence' },
...
const ALWAYS_SECTIONS: { section: string; items: (NavItemDef & { fresh?: boolean })[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/finance',         label: 'Finance (P&L)',   icon: DollarIcon,     section: 'Growth', badge: 'New', fresh: true },
