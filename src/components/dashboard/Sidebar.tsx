...
const NAV = [
  {
    ...
    items: [
      ...
      { href: '/dashboard/ask-aria', label: 'Ask Aria', icon: ChatIcon, badge: 'AI' },
    ],
  },
  {
    section: 'Revenue',
    items: [
      { href: '/dashboard/bookings', label: 'Bookings + sales', icon: CalendarIcon },
      { href: '/dashboard/winback', label: 'Customer winback', icon: UsersIcon },
      { href: '/dashboard/churn', label: 'Slow day filler', icon: DollarIcon, badge: '⚡' },
    ],
  },
  {
    section: 'Reputation',
    items: [
      ...
      { href: '/dashboard/competitors', label: 'Competitor watch', icon: SearchIcon },
    ],
  },
  {
    section: 'Intelligence',
    items: [
      { href: '/dashboard/profit-leaks', label: 'Profit leaks', icon: AlertIcon },
      { href: '/dashboard/churn', label: 'Churn prevention', icon: TrendingDownIcon },
    ],
  },
  {
    section: 'Pro tools',
    items: [
      { href: '/dashboard/quote-builder', label: 'Quote builder', icon: FileTextIcon },
...
export function Sidebar({ business }: { business: Business }) {
  ...
  return (
    <aside className="w-[220px] flex-shrink-0 bg-[#13131a] h-screen flex flex-col overflow-y-auto">
      {/* Logo */}
      <div className="px-5 py-[22px] flex-shrink-0">
...
function FileTextIcon({ className }: { className?: string }) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>;
}
