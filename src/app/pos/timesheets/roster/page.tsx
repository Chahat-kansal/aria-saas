...
const C = { bg:"rgba(17,15,26,0.95)", card:"rgba(26,23,40,0.9)", border:"transparent", text:"#EDE8FF", muted:"#8B85A8", dim:"#4A4565", violet:"#006AFF", green:"#00B140", red:"#EF4444", amber:"#F59E0B", cyan:"#006AFF" };
...
function ShiftEditor({shift,onSave,onRemove,onCancel}:{shift:Shift;onSave:(s:Shift)=>void;onRemove:()=>void;onCancel:()=>void;}){
  ...
  const C2={...{bg:"rgba(17,15,26,0.95)",card:"rgba(26,23,40,0.9)",border:"transparent",text:"#EDE8FF",muted:"#8B85A8",dim:"#4A4565",violet:"#006AFF",green:"#00B140",red:"#EF4444"}};
  const hours=hoursFromTimes(start,end,brk);
  const iCls={background:"#FFFFFF",border:`1px solid ${C2.border}`,borderRadius:8,padding:"9px 12px",fontSize:13,color:C2.text,outline:"none",fontFamily:"inherit",width:"100%"} as React.CSSProperties;
