export default function BalancesPage() {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-[#1a1a16]">Balances</h1>
        <p className="text-xs text-[rgba(26,26,22,.45)] mt-0.5">Customer account balances and credit management</p>
      </div>
      <div className="bg-white rounded-2xl border border-[rgba(0,0,0,.08)] shadow-sm p-12 text-center">
        ...
        <p className="text-sm font-medium text-[#1a1a16] mb-1">Balances</p>
