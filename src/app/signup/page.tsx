    ...
    <div className="min-h-screen bg-[#f5f4ef] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-medium text-[#1a1a16]">Start your free trial</h1>
          <p className="text-sm text-[rgba(26,26,22,0.45)] mt-1">14 days free. No credit card required.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[rgba(0,0,0,0.08)] p-8 shadow-sm">
          ...
          <p className="text-center text-[11px] text-[rgba(26,26,22,0.3)] mt-4 leading-relaxed">
