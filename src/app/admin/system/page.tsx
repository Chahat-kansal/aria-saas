...
const ENV_VARS = [
  ...
  { key: 'CLICKSEND_USERNAME',           label: 'ClickSend Username',     group: 'Communication', note: 'SMS sending' },
  { key: 'CLICKSEND_API_KEY',            label: 'ClickSend API Key',      group: 'Communication', note: 'SMS auth' },
