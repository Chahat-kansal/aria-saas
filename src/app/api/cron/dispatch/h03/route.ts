...
import { GET as hypothesisEngineBatchPoll } from '@/app/api/cron/hypothesis-engine-batch-poll/route'
...
// AI-COST-2 — hypothesis-engine-batch-poll added alongside daily-briefing-poll (same ~11h
// submit-to-poll margin from their shared h15/h16 submit hours).
export const GET = (req: Request) => runDispatcher(req, 'h03', [
  { name: 'daily-briefing-poll', fn: dailyBriefingPoll },
  { name: 'hypothesis-engine-batch-poll', fn: hypothesisEngineBatchPoll },
