...
async function _POST(req: Request) {
  ...
  const msg = 
await trackAICall({ route: 'aria/generate-purchase-orders', model: 'claude-sonnet-4-6', businessId: business_id, purpose: 'purchase-order-generate' }, () => anthropic.messages.create({
