...
async function _POST(req: Request) {
  ...
  const msg = 
await trackAICall({ route: 'aria/generate-purchase-orders', model: 'claude-sonnet-4-5-20250929', businessId: business_id, purpose: 'purchase-order-generate' }, () => anthropic.messages.create({
