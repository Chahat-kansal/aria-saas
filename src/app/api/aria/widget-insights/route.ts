...
async function _POST(req: Request) {
  ...
  const msg =
await trackAICall({ route: 'aria/widget-insights', model: 'claude-sonnet-4-5-20250929', businessId: business_id, purpose: 'widget-insights' }, () => anthropic.messages.create({
