...
export const GET = withErrorCapture('pos/orders', _GET)
export const POST = withErrorCapture('pos/orders', _POST)
export const PATCH = withErrorCapture('pos/orders', _PATCH)
