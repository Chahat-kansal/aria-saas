...
export const GET = withErrorCapture('pos/customer-groups', _GET)
export const POST = withErrorCapture('pos/customer-groups', _POST)
export const PATCH = withErrorCapture('pos/customer-groups', _PATCH)
export const DELETE = withErrorCapture('pos/customer-groups', _DELETE)
