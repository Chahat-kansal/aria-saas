...
export const GET = withErrorCapture('pos/modifiers', _GET)
export const POST = withErrorCapture('pos/modifiers', _POST)
export const PATCH = withErrorCapture('pos/modifiers', _PATCH)
export const DELETE = withErrorCapture('pos/modifiers', _DELETE)
