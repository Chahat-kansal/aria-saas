...
export const GET = withErrorCapture('warehouse/serials', _GET)
export const POST = withErrorCapture('warehouse/serials', _POST)
export const PATCH = withErrorCapture('warehouse/serials', _PATCH)
