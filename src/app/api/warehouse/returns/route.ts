...
export const GET = withErrorCapture('warehouse/returns', _GET)
export const POST = withErrorCapture('warehouse/returns', _POST)
export const PATCH = withErrorCapture('warehouse/returns', _PATCH)
