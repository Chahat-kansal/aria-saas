...
import { TiersTab, ReferralsTab, RewardRulesTab, RevenueForecastCard, BrandingSection, OffersTab, MemberPricingSection, ChallengesSection, TierPerksSection, PreloadSection, WhatsAppSection } from '@/components/dashboard/LoyaltyExtensions'
