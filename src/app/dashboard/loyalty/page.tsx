...
import { TiersTab, ReferralsTab, RewardRulesTab, RevenueForecastCard, BrandingSection, OffersTab, MemberPricingSection, ChallengesSection, TierPerksSection, PreloadSection, WhatsAppSection, CommunityLevelsSection, CommunityLeaderboardRewardsSection } from '@/components/dashboard/LoyaltyExtensions'
...
export default function LoyaltyPage() {
  ...
  return (
    <div className="p-6 max-w-6xl space-y-8" style={{ color: 'var(--text-primary, #E8EDE7)' }}>
      ...
      {tab === 'config' && <PreloadSection />}
      {tab === 'config' && <WhatsAppSection />}
      {tab === 'config' && <TierPerksSection />}
      {tab === 'config' && <ChallengesSection />}
      {tab === 'config' && <CommunityLevelsSection />}
      {tab === 'config' && <CommunityLeaderboardRewardsSection />}
