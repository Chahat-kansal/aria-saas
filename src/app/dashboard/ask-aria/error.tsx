...
export default function AskAriaError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center px-6">
      ...
      <h2 className="text-lg font-semibold text-white">Aria is unavailable</h2>
      <p className="text-sm max-w-sm" style={{ color: 'rgba(255,255,255,0.45)' }}>
        The AI council hit an error. Try asking again in a moment.
      </p>
      <button
        onClick={reset}
