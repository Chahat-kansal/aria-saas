...
import type { SearchProduct } from './page'
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '52px 20px 16px' }}>
        <h1 style={{
          fontFamily: FD, fontStyle: 'italic', fontSize: 38, fontWeight: 400,
              ...
              >
                <div style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {product.description && (
                      <p style={{
                        fontFamily: FB, fontSize: 12, color: INK_MUTED, margin: 0,
                  ...
                  <div style={{ flexShrink: 0, textAlign: 'right' }}>
                    <p style={{
                      ...
                      color: INK, margin: '0 0 6px', fontWeight: 700,
                    }}>
