export const industryConfig = {
  retail: {
    ...
    published: true,
    sidebar: ['dashboard', 'custom-features', 'staff', 'pos', 'price-tickets', 'social', 'studio', 'marketing', 'orders', 'delivery', 'parcel-tracking', 'shift-reports', 'audit-checks', 'weekly-reports', 'pos-online', 'winback', 'slow-day', 'reviews', 'seo', 'profit-leaks', 'cash-flow', 'missed-demand', 'intelligence', 'competitors', 'churn', 'reorder', 'variance', 'receipt-scan', 'website-chat'],
