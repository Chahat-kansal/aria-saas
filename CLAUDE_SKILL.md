# CLAUDE_SKILL.md — Aria OS Coding Rules

## RULE 1: Write files with create_file, never as Python strings
Never write TSX/TS as escaped strings inside Python. Use create_file tool.
Never run regex transforms on code. Rewrite the full file cleanly.
...
- After regex replacement, always verify the result parses correctly
